...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'carg_id'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'cati_id'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'carg_guia'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'vuel_id'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'aeco_id_destino_final'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'usua_id_creador'); ?></td>
...
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'liae_id'); ?></td>
<td class=tabla_datos><?php echo mysql_result($rs, $i, 'caes_id'); ?></td>

            <td class=tabla_datos_iconos>
            <div Class='btn-group btn-group-sm'>
                     <a Class='btn' href='javascript:editar(<?php echo mysql_result($rs, $i, 'carg_id'); ?>)' ;>
                     ...
                     <a Class='btn' href='javascript:borrar(<?php echo mysql_result($rs, $i, 'carg_id'); ?>)' ;>
