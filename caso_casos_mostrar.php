            ...
            <tr>
               ...
               <td>
                  <div class="btn-group btn-group-sm">
                     ...
                     <a href="index.php?p=detalle-caso&caso=<?php echo mysql_result($rs, $i, 'caso_id'); ?>" class="btn" style="font-size: 22px;"  ><i class="fa-solid fa-circle-info" style="color: #0041b3;"></i></a>
                  </div>
               </td>
            </tr>
         <?php
