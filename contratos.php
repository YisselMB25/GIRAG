...
<div id="separador">
	...
	<table class=filtros>
		...
		<tr>
			...
			<td class="etiquetas">
				<div id="b_mostrar"><a href="#" class=botones>Mostrar</a></div>
			</td>

			<td>
				<div id="dmodal" style="text-align:right"><a href="#" class=botones>Nueva Plantilla</a></div>
			</td>
